...
class QuestionsProcessor:
    def __init__(
        ...
        answering_model: str = "qwen-flash", # gpt-4o-2024-08-06
    ...
    def _format_retrieval_results(self, retrieval_results) -> str:
        """将检索结果格式化为RAG上下文字符串（带来源文件，便于模型采信纯文本/季报）"""
        ...
        for result in retrieval_results:
            ...
            if source_file:
                header = f'Text retrieved from source "{source_file}" (page {page_number}):'
            else:
                header = f'Text retrieved from page {page_number}:'
